...
| `APPRISE_URLS` | No | — | Comma-separated Apprise notification URLs (e.g. `ntfy://host/topic?token=...`). Sent via bundled `apprise-go` binary directly — no external API server needed. |
